...
## script to obtain SNP summary statistics for Olink proteins and Covid-19
...
#! Name of the job:
#SBATCH -J snp_stats_olink_covid
...
scripts/10_SNP_stats_Olink_COVID19.R ${pheno} ${chr} ${LOWPOS} ${UPPOS} "${rsid}"
